...
class _ProfileTypesState extends State<ProfileTypes>{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: SafeArea( child:  Consumer<DataProvider>(builder: (context, productProvider, child) {
              ...
              child: Column(
                children: [
                  CommonElevatedButton(
                    onPressed: () async {
                      chooseUserTypeApi(context,productProvider,isTermsChecks);
  ...
  void chooseUserTypeApi(BuildContext context,DataProvider productProvider, bool isTermsChecks)async {
    Utils.onLoading(context, "");
    await productProvider.getChooseUserType(ChooseUserTypeRequestModel(leadId: 310,));
