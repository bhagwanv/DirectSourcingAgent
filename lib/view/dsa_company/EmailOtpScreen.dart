...
import '../personal_info/model/OTPValidateForEmailRequest.dart';
...
class _OtpScreenState extends State<EmailOtpScreen> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'We just sent you an verification code on your email ID Please enter otp to verify',
    ...
    if (otpText.isEmpty) {
      ...
      try {
        ...
        if (productProvider.getValidOtpEmailData == null ||
          ...
          Utils.showBottomToast(productProvider.getValidOtpEmailData!.message!);
        } else {
          isValid = true;
  ...
  void reSendOpt(BuildContext context, DataProvider productProvider, CountdownController controller, String? emailID) async {
    ...
    if (sendOtpOnEmailResponce != null && sendOtpOnEmailResponce.status!) {
      ...
      Utils.showBottomToast("Otp send to your email");
    }
